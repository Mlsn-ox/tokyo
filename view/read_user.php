<?php
    ...
    try {
        ...
        $inscriptionDate = new DateTime($user["user_ins"]); // ou ta date récupérée en BDD
        $now = new DateTime();
...
<div class="section p-1 col-xxl-7 col-md-10 col-sm-11 col-12 mx-auto d-flex flex-column justify-content-center overflow-hidden petales">
    <div class="container-fluid p-xl-5 p-md-4 p-3 rounded-5 p-4 mb-3 mb-md-4 home fading user">        
        ...
        <div class="fade-up">
            <h1 class="text-center mt-4 mb-2 pt-5"><?= htmlentities($user["user_name"]) ?></h1>
            <p class="text-center"><?= htmlentities($user["user_mail"]) ?></p>
