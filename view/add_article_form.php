...
<div class="section bg-white col-xxl-7 col-md-9 col-12 mx-auto p-4">
    <div class="container">
        ...
        <form class="mt-4"
            action="../controller/add_article_controller.php"
            method="POST"
            ...
            <div class="mb-3">
                ...
                <div id="map"
                    class="leaflet-container leaflet-touch leaflet-fade-anim leaflet-grab leaflet-touch-drag leaflet-touch-zoom mb-3">
                </div>
                <input type="hidden"
                    id="lat"
                    name="lat"
            ...
            <div class="mb-3">
                <input class="files d-none"
                    type="file"
                    name="image"
                    id="formFile image_uploads"
                    accept=".png, .jpg, .jpeg, .webp, .avif, .tiff">
                <label for="formFile image_uploads"
                    class="form-label btn btn-warning">
                    Ajouter une photo
                </label>
